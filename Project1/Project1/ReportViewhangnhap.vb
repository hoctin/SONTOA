...
Public Class ReportViewhangnhap
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Project1.ReportViewhangnhap.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportViewhangnhap
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportViewhangnhap = New ReportViewhangnhap()
        rpt.Site = Me.Site
        Return rpt
    End Function
